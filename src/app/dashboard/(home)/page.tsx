...
export default function MyApp() {
  ...
  return (
    <div
      className="pt-10 relative w-vh h-full overflow-hidden text-white bg-cover bg-center font-sans"
    ...
    >
      ...
      <div className="relative z-10 w-full h-full grid grid-rows-[auto_auto_1fr_auto] p-4">
        ...
        <main className="grid grid-cols-12 gap-6 mt-6 cursor-pointer">
          ...
          <section className="col-span-3">
            ...
            <Image
              src="/images/laptop-terminal.png"
              alt="Dropzone Logo"
              width={300}
              height={100}
